...
namespace MyList
{
    [Activity(WindowSoftInputMode = SoftInput.AdjustPan, Icon = "@drawable/icon", MainLauncher = true)]
    public class SignInActivity : Android.Support.V4.App.FragmentActivity
    {
        ...
        protected override void OnCreate(Android.OS.Bundle savedInstanceState)
        {
            ...
            if (savedInstanceState == null)
                SupportFragmentManager.BeginTransaction().Replace(Resource.Id.sign_in_container, SignInFragment.Create(edit)).Commit();
        }
